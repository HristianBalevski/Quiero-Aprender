...
def add_event(request):
    ...
    if request.method == 'POST':
        ...
        if not title or not start or not end:
            return render(request, 'events/add_event.html', {'error': 'All fields are required!'})
        ...
        Event.objects.create(title=title, start_time=start, end_time=end, description=description)
